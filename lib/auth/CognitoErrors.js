...
const RequestFormatError = {
    name: "RequestFormatError",
    code: "RequestFormatError",
    statusCode: 400,
    message: "Error with the format of your request, likely missing something or wrong API key."
}
...
const NotAuthorizedException = {
    ...
    statusCode: 400,
    message: "User information is incorrect, or the user is already confirmed.",
}
